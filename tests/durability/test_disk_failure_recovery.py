...
class TestDiskFailureRecovery:
    ...
    def test_near_full_fail_disk_diff_cvg_less_than_k(self):
        ...
        resp = self.near_full_storage_obj.get_user_data_space_in_bytes(self.node_master_list[0],
                                                            self.near_full_percent)
        assert_utils.assert_true(resp[0], resp[1])
        ...
        if workload_info:
            ...
            self.near_full_storage_obj.perform_operations_on_pre_written_data(s3userinfo=s3userinfo,
